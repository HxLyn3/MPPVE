...
if __name__ == "__main__":
    ...
    parser.add_argument("--task", default="Hopper-v3")
    parser.add_argument("--algos", type=str, nargs='*', default=["mppve"])
    parser.add_argument("--query-file", default="progress.csv")
    parser.add_argument("--query-x", default="timestep")
    parser.add_argument("--query-y", default="eval/episode_rewards")
    parser.add_argument("--title", default=None)
    parser.add_argument("--xlabel", default="timestep")
    parser.add_argument("--ylabel", default="Test Reward Mean")
